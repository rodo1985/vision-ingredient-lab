"""Tests for the preserved legacy vision client."""
...
def test_legacy_build_payload_valid(tmp_path: Path) -> None:
...
def test_legacy_analyze_image_parses_response(tmp_path: Path) -> None:
...
def test_legacy_analyze_image_rejects_malformed_response(tmp_path: Path) -> None:
...
def test_legacy_analyze_image_requires_client(tmp_path: Path) -> None:
